      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card title="Stock Overview">
          <div className="grid grid-cols-1 gap-4">
            <SmallCard title="Current Stock Level" value={350} icon={PackageSearch} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card title="Alerts & Notifications">
          <div className="text-gray-600 space-y-2">
            <p><Bell className="inline w-4 h-4 text-primary mr-2" /> Scheduled delivery tomorrow</p>
            <p><Bell className="inline w-4 h-4 text-primary mr-2" /> Stock running low for Item X</p>
          </div>
        </Card>
        ...
        <Card title="User Activity">
          <div className="text-gray-600 space-y-2">
            <p><Users className="inline w-4 h-4 text-primary mr-2" /> John created a delivery order</p>
            <p><Users className="inline w-4 h-4 text-primary mr-2" /> Sarah updated stock levels</p>
          </div>
        </Card>
      </div>
    </div>
